...
void DexNavGetMon(u16 species, u8 potential, u8 level, u8 abilityNum, u16* moves)
{
    ...
    for (i = 0; i < MAX_MON_MOVES; i++)
    {
        ...
        SetMonData(mon, MON_DATA_MOVE1 + i, &Var8006);
...
void ToolSelection(u8 taskId)
{
    switch (priv0)
    {
        ...
        case 1:
            ...
            AddTextPrinterParameterized3(boxId, 1, 8, 2, &MenuTextBlack, 0, gText_DexNavText);
            Menu_InitCursor(boxId, 2, 0, 1, 16, TOOL_COUNT, 0);
